...
urlpatterns = [
    ...
    url(r"^teaching/edit$", views.Teaching_Edit,name='teaching_edit'),
    ...
    url(r"^recognition/edit$", views.Recognition_Edit,name='recognition_edit'),
    url(r"^recognition/add$", views.Recognition_Add, name='recognition_add'),
    url(r"^publication/$", views.Publication,name='publication'),
    url(r"^publication/edit$", views.Publication_Edit,name='publication_edit'),
    url(r"^publication/add$", views.Publication_Add, name='publication_add'),
    url(r"^students/$", views.Students,name='students'),
    url(r"^students/edit$", views.Students_Edit,name='students_edit'),
